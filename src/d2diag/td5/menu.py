...
TD5_MENU = [
    ...
    {"cat": "Inputs — Fuelling / live (22)", "items": [
        ...
        {"name": "7. Accel. Way 3 (V)", "status": "maybe", "ref": "21 1B@4 — spänningsspår (way3-skala kräver pedalsvep)", "lid": "1b", "sig": "accel_way3"},
        ...
        {"name": "11. Air Inlet Temp (°C)", "status": "ok", "ref": "21 1A@4 (skala ej bilbekräftad)", "lid": "1a", "sig": "air_temp"},
        {"name": "12. Air Flow (gr/hr)", "status": "maybe", "ref": "21 1C@4 (maf_raw) — ingen MAF-givare", "lid": "1c", "sig": "maf_raw"},
        {"name": "13. Ambient Pressure (kPa)", "status": "ok", "ref": "21 23", "lid": "23", "sig": "ambient_press_1"},
        {"name": "14. Manifold Turbo Pressure (kPa)", "status": "ok", "ref": "21 1C@0 — BEKRÄFTAT 2026-08-03", "lid": "1c", "sig": "manifold_press"},
        {"name": "15. EGR Modulator (%)", "status": "todo", "ref": "ej avkodad", "lid": "1c"},
        {"name": "16. EGR Inlet (%)", "status": "todo", "ref": "ej avkodad", "lid": "1c"},
        {"name": "17. Wastegate Modulator (%)", "status": "todo", "ref": "ej avkodad", "lid": "1c"},
        {"name": "18. Cylinder 1 (balans)", "status": "ok", "ref": "21 40@0 (s16)", "lid": "40", "sig": "balance_1"},
        {"name": "19. Cylinder 2 (balans)", "status": "ok", "ref": "21 40@2", "lid": "40", "sig": "balance_2"},
        {"name": "20. Cylinder 3 (balans)", "status": "ok", "ref": "21 40@4", "lid": "40", "sig": "balance_3"},
        {"name": "21. Cylinder 4 (balans)", "status": "ok", "ref": "21 40@6", "lid": "40", "sig": "balance_4"},
        {"name": "22. Cylinder 5 (balans)", "status": "ok", "ref": "21 40@8", "lid": "40", "sig": "balance_5"},
    ]},
    {"cat": "Inputs — switchar (12)", "items": [
        {"name": "1. Brake Switch 1", "status": "todo", "ref": "", "lid": "1e 36"},
        {"name": "2. Brake Switch 2", "status": "todo", "ref": "jfr par med Brake 1 (komplementära)", "lid": "1e 36"},
