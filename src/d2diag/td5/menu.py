...
TD5_MENU = [
    ...
    {"cat": "Inputs — Fuelling / live (22)", "items": [
        ...
        {"name": "12. Air Flow (gr/hr)", "status": "maybe", "ref": "21 1C@4 (maf_raw) — no MAF sensor", "lid": "1c", "sig": "maf_raw"},
        ...
        {"name": "15. EGR Modulator (%)", "status": "todo", "ref": "not decoded", "lid": "1c"},
        {"name": "16. EGR Inlet (%)", "status": "todo", "ref": "not decoded", "lid": "1c"},
        {"name": "17. Wastegate Modulator (%)", "status": "todo", "ref": "not decoded", "lid": "1c"},
