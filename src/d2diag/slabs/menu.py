...
SLABS_MENU = [
    ...
    {"cat": "Inputs — ABS", "items": [
        ...
        {"name": "Hjulhastighet FR/FL/RR/RL", "status": "maybe", "ref": "21 43", "lid": "43"},
        {"name": "Inlet valve FR/FL/RR/RL (V)", "status": "maybe", "ref": "21 44/49/57 (offset ej isolerat)", "lid": "44 49 57"},
    ...
    {"cat": "Inputs — SLS", "items": [
        {"name": "Left/Right Sensor Value (höjd)", "status": "ok", "ref": "21 54 b0/b1", "lid": "54"},
        {"name": "Left/Right Sensor Supply (V)", "status": "maybe", "ref": "21 53/55 (sniffat 08-08)", "lid": "53 55"},
    ...
    {"cat": "Inputs — Switchar", "items": [
        {"name": "Any Door (öppen/stängd)", "status": "ok", "ref": "21 56 byte0 bit0 — BELAGT (00 stängd/01 öppen)", "lid": "56", "sig": "any_door"},
        {"name": "Neutral/LowRange/DiffLock/Reverse/HDC/Shuttle", "status": "maybe", "ref": "21 42/48/56/58 (bit ej isolerad)", "lid": "42 48 56 58"},
